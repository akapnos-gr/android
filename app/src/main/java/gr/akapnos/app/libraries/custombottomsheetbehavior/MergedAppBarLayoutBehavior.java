package gr.akapnos.app.libraries.custombottomsheetbehavior;
...
public class MergedAppBarLayoutBehavior extends AppBarLayout.ScrollingViewBehavior {
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, View child, View dependency) {
        ...
        if(isDependencyYBelowAnchorPoint(parent, dependency)){
            ...
            setFullBackGroundColor(R.color.keyColor);
            setPartialBackGroundHeight(0);
        }
        return childMoved;
    }
    ...
    private void init(@NonNull CoordinatorLayout parent, @NonNull View child){
        ...
        mToolbar = appBarLayout.findViewById(R.id.expanded_toolbar);
        ...
        if (mTitleTextView == null)
            return;
        mTitleTextView2 = appBarLayout.findViewById(R.id.toolbar_title);
        if (mTitleTextView2 == null)
            return;
        mSubtitleTextView = appBarLayout.findViewById(R.id.toolbar_subtitle);
...
//        setStatusBarBackgroundVisible(mVisible);
        ...
        setFullBackGroundColor(mVisible && mCurrentTitleAlpha == 1 ? R.color.keyColor : android.R.color.transparent);
        setPartialBackGroundHeight(0);
        mTitleTextView.setText(mToolbarTitle);
        mTitleTextView.setAlpha(mCurrentTitleAlpha);
        mTitleTextView2.setText(mToolbarTitle);
        mTitleTextView2.setAlpha(mCurrentTitleAlpha);
        mSubtitleTextView.setText(mToolbarSubtitle);
        mSubtitleTextView.setAlpha(mCurrentTitleAlpha);
    ...
    private void setTitleVisible(boolean visible){
        ...
        if(mTitleAlphaValueAnimator == null || !mTitleAlphaValueAnimator.isRunning()){
            ...
            setToolbarSubTitle(mToolbarSubtitle);
            ...
            mTitleAlphaValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    mTitleTextView2.setAlpha((Float) animation.getAnimatedValue());
                    mSubtitleTextView.setAlpha((Float) animation.getAnimatedValue());
                }
            });
    ...
    private boolean isStatusBarVisible(){
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){
            return ((Activity)mContext).getWindow().getStatusBarColor() == ContextCompat.getColor(mContext,R.color.keyColor2);
        }
        return true;
    }
    ...
    private void setStatusBarBackgroundVisible(boolean visible){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){
            if(visible){
                ...
                window.setStatusBarColor(ContextCompat.getColor(mContext,R.color.keyColor2));
            }else {
                Window window = ((Activity)mContext).getWindow();
    ...
    public void setToolbarTitle(String title) {
        ...
        if (this.mTitleTextView2 != null) {
            this.mTitleTextView2.setText(title);
        }
    ...
    public void setToolbarSubTitle(String subtitle) {
        this.mToolbarSubtitle = subtitle;
    ...
    public void onRestoreInstanceState(CoordinatorLayout parent, View child, Parcelable state) {
        ...
        this.mToolbarSubtitle = ss.mToolbarSubtitle;
    ...
    protected static class SavedState extends View.BaseSavedState {
        ...
        public SavedState(Parcel source) {
            ...
            mToolbarSubtitle = source.readString();
            mTitleAlpha = source.readInt();
        }

        public SavedState(Parcelable superState, boolean visible, String toolBarTitle, String toolBarSubtitle, int titleAlpha) {
            super(superState);
            this.mVisible = visible;
            this.mToolbarTitle = toolBarTitle;
            this.mToolbarSubtitle = toolBarSubtitle;
        ...
        public void writeToParcel(Parcel out, int flags) {
            ...
            out.writeString(mToolbarSubtitle);
